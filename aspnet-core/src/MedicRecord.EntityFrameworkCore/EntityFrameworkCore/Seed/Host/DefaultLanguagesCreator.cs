...
namespace MedicRecord.EntityFrameworkCore.Seed.Host;

public class DefaultLanguagesCreator
{
    public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

    private readonly MedicRecordDbContext _context;

    private static List<ApplicationLanguage> GetInitialLanguages()
    {
        var tenantId = MedicRecordConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(MedicRecordDbContext context)
    {
        _context = context;
    }
